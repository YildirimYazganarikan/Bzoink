...
interface GameCanvasProps {
  ...
  isPaused: boolean;
  onTogglePause: () => void;
  onUpdateStats: (health: number, score: number) => void;
}
...
const GameCanvas = forwardRef<GameCanvasHandle, GameCanvasProps>(({ settings, isPaused, onTogglePause, onUpdateStats }, ref) => {
  ...
  useEffect(() => {
    ...
    const loop = (timestamp: number) => {
      ...
      if (timestamp - lastStatsUpdateRef.current > 100) {
        ...
        onUpdateStats(reportHealth, scoreRef.current);
